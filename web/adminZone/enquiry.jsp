<%-- 
    Document   : enquiry
    Created on : May 1, 2024, 10:50:47 AM
    Author     : 91982
--%>
            ...
            <div class="row">
                <nav id="sidebarMenu" class="border-end col-md-2 col-lg-2 d-md-block navbar-dark sidebar collapse">
                    ...
                    <div class="position-sticky pt-3" id="side">
                        ...
                        <ul class="nav flex-column mt-3">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center" aria-current="page" href="ahome.jsp">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active d-flex align-items-center" aria-current="page" href="enquiry.jsp">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Enquiry Management</h1>
                    </div>
                    <table class="table table-bordered table-striped" style="margin:auto;width:90%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="includes/enqdel.jsp?id=<%=rs.getString("id")%>">
