<%-- 
    Document   : courses
    Created on : May 1, 2024, 10:51:12 AM
    Author     : 91982
--%>
        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="sidebarMenu" class="border-end col-md-2 col-lg-2 d-md-block navbar-dark sidebar collapse">
                    ...
                    <div class="position-sticky pt-3" id="side">
                        ...
                        <ul class="nav flex-column mt-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="courses.jsp">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <form class="form-group" method="post" action="includes/courseHandler.jsp">
                    ...
                    <table class="table table-bordered" style="margin:auto;width:70%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="includes/delcourse.jsp?id=<%=rs.getString("id")%>">
