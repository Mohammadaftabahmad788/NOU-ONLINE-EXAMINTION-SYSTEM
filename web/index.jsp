...
<html lang="en" data-bs-theme="dark">
    ...
    <body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="77">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item nav-link"><button type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target="#loginModal">
                                Login
                            </button>
                        </li>
                    </ul>
        ...
        <header class="masthead" style="background-image: url('assets/img/c4.jpg');" id="home">
        ...
        <footer class="text-center py-4">
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-3">
                    <div class="col">
                        <p class="my-2 text-white-50">Copyright&nbsp;© 2024 OES</p>
                    </div>
                    <div class="col">
