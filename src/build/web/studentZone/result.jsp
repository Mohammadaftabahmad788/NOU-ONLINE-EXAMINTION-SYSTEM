<%-- 
    Document   : result
    Created on : May 1, 2024, 10:42:05 AM
    Author     : 91982
--%>
                ...
                <nav id="sidebarMenu" class="border-end col-md-2 col-lg-2 d-md-block navbar-dark sidebar collapse">
                    ...
                    <div class="position-sticky pt-3" id="side">
                        ...
                        <ul class="nav flex-column mt-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="result.jsp">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <nav class="navbar navbar-expand-lg navbar-dark border-bottom">
                        <div class="container-fluid">
                            ...
                            </svg>&nbsp;&nbsp;&nbsp;<a class="navbar-brand" href="#">Welcome to the NOU-Online Exam Portal, ${name}</a>
                    ...
                    <div class="pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Result is displayed here</h1>
                    </div>
