...
<%
    String userid = (String) session.getAttribute("rollno");
    ...
    if (userid != null && oldpass != null && newpass != null && confirmpass != null) {
        if (newpass.equals(confirmpass)) { // Check if newpass and confirmpass match
            ...
            if (rs.next()) {
                ...
                out.print("<script>alert('Old password is incorrect');window.location.href='shome.jsp';</script>");
            }
        } else {
            out.print("<script>alert('New password and confirm password do not match');window.location.href='shome.jsp';</script>");
        }
    } else {
        out.print("<script>alert('Invalid input');window.location.href='shome.jsp';</script>");
    }
%>
